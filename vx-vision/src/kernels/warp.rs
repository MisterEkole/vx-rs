...
impl ImageWarp {
    ...
    pub fn affine(
        ...
        Self::encode_2d(
            &self.affine_pipeline,
            &encoder,
            input,
            output,
            &params as *const _ as *const c_void,
            mem::size_of::<WarpAffineParams>(),
        );
    ...
    pub fn perspective(
        ...
        Self::encode_2d(
            &self.perspective_pipeline,
            &encoder,
            input,
            output,
            &params as *const _ as *const c_void,
            mem::size_of::<WarpPerspectiveParams>(),
        );
