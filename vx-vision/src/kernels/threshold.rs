...
use crate::types::{AdaptiveThresholdParams, ThresholdParams};
...
impl Threshold {
    ...
    pub fn otsu(&self, ctx: &Context, input: &Texture, output: &Texture) -> Result<f32> {
