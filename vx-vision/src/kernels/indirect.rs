...
impl IndirectDispatch {
    ...
    pub fn encode_indirect_args(
        ...
        let args_buf: UnifiedBuffer<IndirectArgs> = UnifiedBuffer::new(ctx.device(), 1)?;
        ...
        unsafe {
            ...
            encoder.setBytes_length_atIndex(
                NonNull::new_unchecked(&params as *const IndirectSetupParams as *mut c_void),
    ...
    pub fn encode_fast_harris_chain(
        ...
        self.encode_harris_indirect(
            encoder,
            texture,
            &fast_buffers.corners,
            &args_buf,
            harris_config,
            fast_buffers.max_corners,
        )?;
