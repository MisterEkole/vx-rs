...
impl IntegralImage {
    ...
    pub fn compute(&self, ctx: &Context, input: &Texture) -> Result<Texture> {
        let w = input.width();
        let h = input.height();
